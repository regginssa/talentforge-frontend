    ...
    <div className="w-full">
      <ul className="list-disc py-4 px-12">
        <li>
          ...
          writing and translation project directly from WorkLanc - Freelancer’s
          talent marketplace.
        </li>
        <li>
          ...
          creative writing to proofreading and editing services, projects are
        ...
        <li>
          ...
          fill your writing and translation talent gaps with their own
          professional teams.
        </li>
      </ul>
    </div>
