    ...
    <div className="w-full">
      <ul className="list-disc py-4 px-12">
        <li>
          ...
          sales or marketing project directly from Worklanc - Freelancer’s
          talent marketplace.
        </li>
        <li>
          ...
          market research and strategy to SEO and SEM services, projects are
        ...
        <li>
          ...
          the top 1% of sales and marketing talent on Worklanc - Freelancer.
        ...
        <li>
          ...
          fill your sales and marketing talent gaps with their own professional
          teams.
        </li>
      </ul>
    </div>
