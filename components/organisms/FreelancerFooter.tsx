...
export default function FreelancerFooter() {
  ...
  return (
    <footer className="w-[80%] mx-auto bg-zinc-900 mb-8 rounded-lg">
      <div className="max-w-7xl mx-auto py-14 text-sm text-white mt-10">
        ...
        <p className="mt-4 text-sm">© 2024 - 2026 Worklanc® Global LLC</p>
      </div>
    </footer>
  );
}
