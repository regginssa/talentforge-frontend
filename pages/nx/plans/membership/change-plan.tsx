...
import { FreelancerFooter, FreelancerHeader } from "@/components/organisms";
import {
  Tooltip,
  TooltipContent,
  TooltipTrigger,
              ...
              <li>
                <span className="inline-flex items-center gap-1">
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent side="right">
                      <p className="text-sm p-2">
                        Get unlimited assistance from Uma, WorkLanc's Mindful
                        AI, built into your everyday workflow to help boost your
                        productivity.
                      </p>
                    </TooltipContent>
                  </Tooltip>
