...
export const SERVICES_DESIGN_SEO: TSEO = {
  title: "Online Design Services | TalentForge - Freelancer",
  description:
    "Discover a wide range of online design services including logo design, brand identity, illustration, packaging, digital and print design, photography, building & home design, infographics, and product & game design by TalentForge.",
  keywords:
...
export const SERVICES_DESIGN_SUBCATEGORIES_DATA = [
  {
    brandidentitydesign: {
      ...
      seo: {
        title:
          "Brand Identity Design Services | TalentForge - Freelancer",
        description:
          "Explore expert brand identity design services including logo design, business cards, brand style guides, voice & tone, and complete branding solutions. Elevate your brand with TalentForge.",
        keywords:
          "brand identity design, logo design, business card design, brand style guides, branding services, brand voice and tone, stationery design, freelancer branding expert, TalentForge",
        url: "/",
        image: "",
      } as TSEO,
      topProjects: [],
